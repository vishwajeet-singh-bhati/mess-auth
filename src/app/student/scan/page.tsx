...
type ScanPhase = 'loading' | 'scanning' | 'processing' | 'success' | 'denied'
    ...
    <div style={{
      ...
      {phase === 'success' && result?.success && (
        <div style={{ flex:1, display:'flex', flexDirection:'column', background:'#0a0a0a', animation:'fadeUp 0.35s ease both' }}>
          <div style={{ background:'linear-gradient(135deg,#14532d,#166534)', padding:'3.5rem 2rem 2.5rem',
            textAlign:'center', display:'flex', flexDirection:'column', alignItems:'center', gap:'1rem' }}>
            <div style={{ width:'72px', height:'72px', borderRadius:'50%', background:'rgba(255,255,255,0.15)',
